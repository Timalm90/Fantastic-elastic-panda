...
export function SceneDebugController({ 
  ...
  const config = useControls('Scene', {
    ...
    ambientIntensity: { value: 0.5, min: 0, max: 3, step: 0.1 },
    light1Intensity: { value: 500, min: 0, max: 500, step: 1 },
    light1X: { value: -0.5, min: -30, max: 30, step: 0.5 },
    light1Y: { value: -5, min: -30, max: 30, step: 0.5 },
    light1Z: { value: -3, min: -30, max: 30, step: 0.5 },
    light1Color: light1Color,
    light2Intensity: { value: 500, min: 0, max: 500, step: 1 },
    light2X: { value: 1.0, min: -30, max: 30, step: 0.5 },
    light2Y: { value: 11.5, min: -30, max: 30, step: 0.5 },
    light2Z: { value: 7.0, min: -30, max: 30, step: 0.5 },
    light2Color: light2Color,
    light3Intensity: { value: 500, min: 0, max: 500, step: 1 },
    light3X: { value: 0, min: -30, max: 30, step: 0.5 },
    light3Y: { value: 3, min: -30, max: 30, step: 0.5 },
    light3Z: { value: -1.5, min: -30, max: 30, step: 0.5 },
